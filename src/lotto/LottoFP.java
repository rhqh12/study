...
public class LottoFP {
	...
	private static void genAuto(LottoFP lotto) {
	...
	private static void genManual(LottoFP lotto) {
		Scanner scan = new Scanner(System.in);
		lotto.tempStorage.clear();
	...
	private static void save(LottoFP lotto){
